    ...
    <div class="content">
    	<div class="support">
  			<div class="support_desc">
  				...
  				<p> This is a demo ecommerce website for education purpose. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters.There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
  			</div>
				...
				?>
					    <form action="" method="post">
						    ...
						    <div>
						    	...
						    	<span><input type="text" name="contact" value="" required></span>
						    </div>
						    <div>
				...
				<div class="col span_1_of_3">
      			<div class="company_address">
				     	<h2>Company Information :</h2>
						    	<p>Online Supper Shop</p>
						   		<p>Shewrapara,Mirpur,Dhaka 1216</p>
						   		<p>Bangladesh</p>
				   		<p>Mobile:01764-843238</p>
				   		<p>Phone: </p>
				 	 	<p>Email: <span>mahbuburrahman2310@gmial.com</span></p>
